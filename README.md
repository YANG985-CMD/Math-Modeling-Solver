...
![Tests](https://img.shields.io/badge/Tests-13%2F13%20passing-16A34A)
...
评分器会生成中文标注的可编辑 SVG 仪表板，并嵌入 HTML 报告。图中使用统一的 0-100% 坐标展示各次运行正确率和四类稳定性，再用带精确数值的热力图展示各题及各评分分项，避免只看总分掩盖局部缺陷。
...
<!-- skill-provenance:v1;owner=YANG985-CMD;id=YANG985-CMD-MMS-2026-v5;path=README.md;sha256=904b7debec24154785f431cf4d7083b0e06bfdcb3027f451ccc2597fe13b424e;pub=0ofp8dKKJWMQK0LUC4dZDC8cynCRQlggy7cVeq7NfBo=;sig=mj3HP9khtnOoDCdRjs2OkrWQkwh64ck-cdV0ccdbki-iVZ0ZEdibv9j6Hq5WA0KvQICfbvejdTZjm8oRw7FLCA== -->
