...
SPECIALIST_SOURCES: dict[str, tuple[str, ...]] = {
    "audit-modeling-evidence": (
        ...
        "scripts/audit_evidence_bundle.py",
        "scripts/init_evidence_bundle.py",
        ...
        "references/evidence-registry-contract.md",
        ...
        "assets/templates/result-registry-template.csv",
        "assets/templates/poc-registry-template.csv",
        "assets/templates/run-record-template.csv",
        "assets/templates/figure-evidence-template.csv",
        "assets/templates/numerical-diagnostics-template.csv",
        "assets/templates/review-pass-items-template.csv",
        "assets/templates/consistency-audit-template.csv",
